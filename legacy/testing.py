...
image_dir = r'C:\Users\Johannes Ora\Documents\Koulu  Tyo  Muut\Space Master\Python signal treatment\JOHALVSAT\JOHALVSAT\data'
...
for filename in os.listdir(image_dir):
    if filename.endswith('.jpg'):
        ...
        image_data.append(image_array[:,:,2]-image_array[:,:,0]) #Show array of only with red channel
        years.append(year)
        months.append(month)
